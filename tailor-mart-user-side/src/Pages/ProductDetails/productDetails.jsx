    ...
    <div className="productDetails-main">
      ...
      <div className="productDetails-wraper">
        {!loading &&
          !error &&
          data
            .filter((item) => item.productName === id)
            .map((items, index) => (
              <div key={index} className="productDetails-cont">
                <div className="productDetails-image-wraper">
                  <div className="w-full">
                    <p
                      onClick={() => setProductLike((prev) => !prev)}
                      className="productLikeButton"
                    >
                      <i
                        className={`${productLike ? "ri-heart-fill" : "ri-heart-line"}`}
                      ></i>
                    </p>
                ...
                {items.productColor && (
                  <div className="productDetails-color-tag-info">
                    <p>
                      <span>Selected Color:</span> {items.productColor}
                    </p>
                ...
                <div className="productDetails-price-wraper">
                  ...
                  <p className="productDetails-discount-price">
                    ₹{items.productPrice}
                  </p>
                ...
                {items.productoffers && (
                  <div className="productDetails-offers">
                    <p>offers</p>
                  </div>
                )}
                {/* <div className='productDetails-wraper'>
