...
function Navbar() {
  ...
  const season = [
    {
      name: "summer",
      logo: "https://images.unsplash.com/photo-1710423914146-dfd361a169c0?q=80&w=749&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      origin: "summer",
    },
    {
      name: "winter",
      logo: "https://images.unsplash.com/photo-1706027369229-8537ba8055eb?q=80&w=1675&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      origin: "winter",
    },
    {
      name: "Rainy season",
      logo: "https://images.unsplash.com/photo-1652471175330-5ac67720c990?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      origin: "rainy",
    },
  ];
  return (
    <div className="all-size-navbar-main">
      ...
      <div className="links">
        <div onClick={() => setOpenPop(true)} className="menu">
      ...
      {openPop && (
        <div className="menu-pop">
          <div className="menu-pop-close-btn">
            <i onClick={() => setOpenPop(false)} className="ri-close-line"></i>
          </div>
          <h1 className="text-mt">Categoryes</h1>
          <div className="Product-Buttons">
            {Product_Buttons.map((items) => (
              <NavLink
                onClick={() => setOpenPop(false)}
                to={`/feed/${items.origin}`}
                className="button"
              >
                <img src={items.logo} alt="" />
                <p className="button-text bottom-right">{items.name}</p>
              </NavLink>
            ))}
          </div>
          <h1 className="text-mt">Seasonal</h1>
          <div className="Product-Buttons">
            {season.map((items) => (
              <NavLink
                onClick={() => setOpenPop(false)}
